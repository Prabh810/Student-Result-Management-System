...
class CourseClass:
    def __init__(self, root):
        ...
        # title
        title = Label(self.root, text="Manage Course Details", font=("goudy old style", 20,"bold"),bg="#033054",fg="white").place(x=10,y=15,width=1340,height=35)
        ...
        lbl_chareges = Label(self.root,text="Charges", font=("goudy old style", 15, 'bold'), bg="white").place(x=10, y=140)
        ...
        self.txt_course_name.place(x=180, y=60, width=200)
        txt_duration = Entry(self.root,textvariable=self.var_duration, font=("goudy old style", 15, 'bold'), bg="lightyellow").place(x=180, y=100, width=200)
        txt_chareges = Entry(self.root,textvariable=self.var_charges, font=("goudy old style", 15, 'bold'), bg="lightyellow").place(x=180, y=140, width=200)
        self.txt_description = Text(self.root, font=("goudy old style", 15, 'bold'), bg="lightyellow")
        self.txt_description.place(x=180, y=180, width=500, height=150)
        ...
        lbl_seachCourseNname = Label(self.root,text="Course Name", font=("goudy old style", 15, 'bold'), bg="white").place(x=720, y=60)
        self.search_var = StringVar()
        txt_seachCourseNname = Entry(self.root,textvariable=self.search_var, font=("goudy old style", 15, 'bold'), bg="lightyellow").place(x=870, y=60, width=180)
