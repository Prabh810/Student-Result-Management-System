...
class ReportClass:
    def __init__(self, root):
        ...
        self.root.geometry("1240x550+80+170")
        self.root.config(bg="white")
        self.root.focus_force()

        # title
        title = Label(self.root, text="View Student Results", font=("goudy old style", 20,"bold"),bg="orange",fg="#262626").place(x=10,y=15,width=1340,height=50)
